...
class _LectureMaterialsPageState extends State<LectureMaterialsPage> {
  final Stream<QuerySnapshot> _lectureMaterialsStream = FirebaseFirestore.instance
      .collection('lecture_materials')
      .snapshots();
          ...
          child: Row(
            ...
            children: [
              ...
              Icon(
                ...
                size: 30, // Change this value to make the icon larger or smaller
